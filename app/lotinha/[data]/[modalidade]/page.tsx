...
export default function LotinhaNumbersPage() {
  ...
  const requiredNumbers = modalidade?.digitos || 16;
  ...
  const handleAvancar = () => {
    ...
    router.push(`/lotinha/${data}/${modalidadeId}/valor?palpites=${encodeURIComponent(palpitesStr)}`);
  };
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
              <div className="text-pink-500 font-bold">{modalidade?.nome || 'LOTINHA 16D'}</div>
