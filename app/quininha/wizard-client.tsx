...
import {
  ChevronLeft, Menu, RefreshCw, Info, Trash2, Clock,
  ChevronUp, Home, Share2, Printer, Loader2, X, Check, Sparkles,
} from 'lucide-react';
...
interface QuininhaWizardClientProps {
...
// ── Main Wizard ────────────────────────────────────────
export function QuininhaWizardClient({ modalidades }: QuininhaWizardClientProps) {
  ...
  const REQUIRED_NUMBERS = 13;
  const NUMBER_POOL = 80;
      ...
      <div className="w-full max-w-md bg-[#111318] min-h-[100dvh] shadow-xl flex flex-col relative overflow-hidden">
        ...
        <header className="sticky top-0 z-40 bg-[#1A202C] px-4 shrink-0">
          <div className="flex h-12 items-center justify-between">
            ...
            <span className="text-base font-bold text-white">QUININHA</span>
            <button
              className="flex h-11 w-11 items-center justify-center rounded-lg active:bg-white/10"
              aria-label="Menu"
            >
                ...
                <div key={s} className="flex-1 flex flex-col items-center gap-1">
                  <div
                    className={cn(
                      ...
                      i <= STEPS.indexOf(step) ? 'bg-[#E5A220]' : 'bg-zinc-700/40'
                    )}
                  />
                </div>
              ))}
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden">
          <div key={step}>
            ...
            {step === 'modalidade' && (
              <div className="p-4">
                <h2 className="text-xl font-bold text-white mb-1">QUININHA</h2>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedModalidade?.id === mod.id
                          ? 'border-[#E5A220] ring-1 ring-[#E5A220]'
                          : 'border-zinc-700/40'
                      )}
                    >
                      <span className="text-white font-bold text-sm">{mod.nome}</span>
                      <div className="text-[#E5A220] text-xs mt-1">{mod.multiplicador}x</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="p-4 border-b border-zinc-700/40 bg-[#1A1F2B]">
                  <div className="flex justify-between items-start">
                    <h2 className="text-lg font-bold text-white">QUININHA</h2>
                    <div className="text-right">
                      <div className="text-red-500 font-bold text-sm">{selectedModalidade?.nome}</div>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected
                              ? 'bg-[#111318] text-white ring-2 ring-[#E5A220]'
                              : isInPalpite
                ...
                <div className="p-4 flex gap-3 mt-auto">
                  ...
                  <button
                    ...
                    className="flex-1 h-14 bg-[#E5A220] rounded-xl font-bold text-zinc-900 disabled:opacity-50 active:scale-[0.98] transition-all"
                  >
                    Avancar
                  </button>
                </div>
            ...
            {step === 'valor' && (
              <div className="p-4">
                ...
                <div className="flex justify-between items-start mb-4">
                  <h2 className="text-xl font-bold text-white">QUININHA</h2>
                  <div className="text-right">
                    <div className="text-red-500 font-bold text-sm">{selectedModalidade?.nome}</div>
              ...
              <div className="flex flex-col">
                ...
                <div className="p-4 mt-auto">
                  <button
                    ...
                    className="w-full h-14 bg-[#E5A220] rounded-xl font-bold text-zinc-900 disabled:opacity-50 disabled:bg-zinc-700 disabled:text-zinc-400 active:scale-[0.98] transition-all"
                  >
                    ...
                    {selectedDias.map((dia, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm text-zinc-300 mb-1">
                        ...
                        <span className={isConfirmed ? 'text-green-600' : ''}>
                          SORTEIO QUINA - {sorteioDays.find((d) => d.dateStr === dia)?.dateLabel || dia}
                        </span>
