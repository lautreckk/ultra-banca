...
function QuininhaFinalizarContent() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Aposta Quininha - Banca Forte',
      ...
      <div className="bg-gray-100 min-h-screen p-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="font-bold text-gray-900 mb-2">{modalidade?.nome || 'QUININHA 13D'}</div>
...
export default function QuininhaFinalizarPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#1A202C]" />}>
      <QuininhaFinalizarContent />
    </Suspense>
  );
}
