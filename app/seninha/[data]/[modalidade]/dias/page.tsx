      ...
      <div className="w-full max-w-md bg-[#111318] min-h-screen shadow-xl flex flex-col">
        ...
        <div className="p-4">
          <div className="border-t border-dashed border-zinc-700/40 pt-4">
            <button
              onClick={() => selectedDays.length > 0 && router.push(getUrlWithUtm(`/seninha/${data}/${modalidadeId}/finalizar?palpites=${encodeURIComponent(palpitesStr)}&valor=${valorPorPalpite}&dias=${encodeURIComponent(selectedDays.join(','))}`))}
