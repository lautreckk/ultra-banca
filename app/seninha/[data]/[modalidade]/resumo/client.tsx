        ...
        {palpites.length > 0 ? (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => router.push(getUrlWithUtm(`/seninha/${data}/${modalidadeId}`))}
              ...
              <button
                onClick={() => router.push(getUrlWithUtm(`/seninha/${data}/${modalidadeId}/dias?palpites=${encodeURIComponent(palpites.join('|'))}&valor=${valorPorPalpite}&total=${valorTotal}`))}
