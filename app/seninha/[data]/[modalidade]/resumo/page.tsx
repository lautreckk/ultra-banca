          ...
          <>
            <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
              <div className="flex justify-between items-center mb-3">
                <span className="font-bold text-gray-900">{modalidade?.nome || 'SENINHA 14D'} -</span>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={() => router.push(`/seninha/${data}/${modalidadeId}`)} className="h-12 bg-[#E5A220] rounded-lg font-semibold text-white">
                Mais Apostas
              </button>
              <button
...
export default function SeninhaResumoPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#1A202C]" />}>
      <SeninhaResumoContent />
    </Suspense>
  );
}
