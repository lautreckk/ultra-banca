...
export default function PixUpConfigPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-base font-semibold text-white mb-1">
              URL do Webhook (configure no painel PixUp)
            </h3>
            <p className="text-sm text-zinc-500 mb-3">
              Copie esta URL e configure no painel da PixUp para receber notificações de pagamento.
            </p>
      ...
      <GatewayConfigForm
        gatewayName="bspay"
        displayName="PixUp"
        description="Configurações do gateway de pagamento PixUp"
        fields={[
        ...
        infoItems={[
          'O gateway PixUp permite receber pagamentos via PIX de forma instantânea.',
          'Configure as credenciais obtidas no painel da PixUp.',
          'Lembre-se de configurar o Webhook URL acima no painel da PixUp.',
          'A PixUp usa a mesma API do BSPay - as credenciais são salvas no mesmo gateway.',
        ]}
      />
    </div>
  );
