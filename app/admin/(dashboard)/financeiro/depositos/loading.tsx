function SkeletonTableRow() {
  return (
    <div className="flex items-center gap-4 px-4 py-3 border-b border-zinc-700/30 animate-pulse">
      ...
      <div className="w-20 h-4 bg-emerald-700/50 rounded" />
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-10 md:h-8 bg-zinc-700 rounded-lg w-full sm:w-28 flex-1 sm:flex-none animate-pulse" />
          ))}
        </div>
      </div>
